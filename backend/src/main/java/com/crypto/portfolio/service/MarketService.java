...
public class MarketService {
        ...
        public void refreshMarketData() {
                ...
                try {
                        ...
                        // Increase to 250 to cover more assets and reduce the need for direct API calls
                        List<Map<String, Object>> newTopCoins = fetchTopCoinsFromApi(1, 250);
        ...
        private List<Map<String, Object>> fetchTopCoinsFromApi(int page, int perPage) {
                try {
                        ...
                        // Enabled sparkline to allow potential graph data from cache
