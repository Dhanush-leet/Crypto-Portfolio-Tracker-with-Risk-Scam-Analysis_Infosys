            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-md p-6 relative">
              ...
              <form onSubmit={handleAddAsset}>
                ...
                <div className="flex gap-3 mt-8">
                  ...
                  >
                    {submitting ? <div className="w-4 h-4 border-2 border-black border-t-transparent rounded-full animate-spin"></div> : (newAsset.id ? 'Update Asset' : 'Add Asset')}
                  </button>
                </div>
              </form>
            </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-[2.5rem] p-8 h-fit">
            ...
            <div className="h-64 mb-8">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart key={`pie-chart-${holdings.length}-${Date.now()}`}>
                  <Pie
                    data={pieData}
                    cx="50%"
                    cy="50%"
